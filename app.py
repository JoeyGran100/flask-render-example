...
app = Flask(__name__)
app.config[
    'SQLALCHEMY_DATABASE_URI'] = "postgresql://wings1201_render_example_user:rj5AN9GlRkcLSfevRAwzwKiGPcWYCncl@dpg-d3p8lsc9c44c73brnid0-a.frankfurt-postgres.render.com/wings1201_render_example"
